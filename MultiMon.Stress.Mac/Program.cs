...
// Usage: MultiMon.Stress.Mac --cycles=50 --windows=1 [--fullscreen] [--soak-seconds=S] [--audio [--audio-file=PATH] [--audio-device=UID] [--audio-gain=0..1] [--audio-pan=-1..1] [--audio-master=0..1]] [--video=CLIP [--video2=CLIP] [--hap] [--force-sw-decode] [--mode=span|individual|split|hap]] [--controller] [--free-run] | --source-check [--video=HAP.mov] [--video2=colour_h264.mp4] | --list-monitors | --list-audio
