...
{
    /// <summary>
    /// Returns the resolved path to the ffmpeg binary, or <c>null</c> if FFmpeg cannot be found.
    /// Searches: an ffmpeg folder next to the app → PATH → the platform's common install locations.
    /// </summary>
